...
urlpatterns = [
    ...
    path('mock-test/<slug:exam_slug>/', views.mock_test_landing, name='mock_test_landing'),
    path('mock-test/<slug:exam_slug>/<slug:city_slug>/', views.mock_test_landing, name='mock_test_city_landing'),
